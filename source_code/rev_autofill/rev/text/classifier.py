...
model_files = {
    'default': 'rev_autofill/text_type_classifier.pkl',
...
class TextClassifier:
    ...
    def classify(self, chart, with_post=False, draw_debug=False, pad=0, save=True):
        """
    ...
    def classify_from_boxes(self, text_boxes, shape, with_post=False):
        ...
        a1=shape[0]
        a2=shape[1]
        data = feature_extractor.from_text_boxes(text_boxes, a1,a2, 0, '')
